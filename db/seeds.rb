...
test_node0 = Node.create!(user_id: test_user2.id, body: "I am the root node", parent_node_id: nil, ord: 0)
test_node1 = Node.create!(user_id: test_user2.id, body: "textbooks to buy", parent_node_id: test_node0.id, ord: 1)
test_node2 = Node.create!(user_id: test_user2.id, body: "groceries", parent_node_id: test_node0.id, ord: 2)
test_node3 = Node.create!(user_id: test_user2.id, body: "fooood", parent_node_id: test_node2.id, ord: 3)
test_node4 = Node.create!(user_id: test_user2.id, body: "milk", parent_node_id: test_node2.id, ord: 4)
test_node5 = Node.create!(user_id: test_user2.id, body: "eggs", parent_node_id: test_node2.id, ord: 5)
test_node6 = Node.create!(user_id: test_user2.id, body: "vacation ideas", parent_node_id: test_node0.id, ord: 6)
