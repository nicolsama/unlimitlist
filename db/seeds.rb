...
test_node14 = Node.create!(user_id: demoUser.id, body: "These are #ideas", parent_node_id: nil, ord: 3)
...
test_node0.save_tags
test_node17.save_tags
test_node3.save_tags
test_node7.save_tags
test_node17.save_tags
